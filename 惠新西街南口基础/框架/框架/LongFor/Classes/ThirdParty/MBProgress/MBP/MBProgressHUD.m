...
static const CGFloat kLabelFontSize = 15.0f; /**标题字体大小*/
static const CGFloat kDetailsLabelFontSize = 15.f; /**详细标题字体大小*/
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        /**改变字体*/
        self.labelFont = [UIFont fontWithName:@"STHeitiSC-Light" size:kLabelFontSize];
...
- (void)updateIndicators {
    ...
    else if (mode == MBProgressHUDETax) {
        [indicator removeFromSuperview];
        self.indicator = MB_AUTORELEASE([[UIImageView alloc] initWithImage:[UIImage imageNamed:@"jiazai_etax"]]);
        self.indicator.backgroundColor = [UIColor clearColor];
        [self addSubview:indicator];
