...
- (void)viewDidLoad {
    ...
    self.cellTitleArray = [NSArray arrayWithObjects:
                           [NSArray arrayWithObjects:@"修改密码",@"我的消息", @"我的预约", @"我的发票", nil],
                           [NSArray arrayWithObjects:@"涉税信息", @"开票设置", nil],
                           [NSArray arrayWithObjects:@"关于", nil],
                           nil];
    self.cellIconArray = [NSArray arrayWithObjects:
                          [NSArray arrayWithObjects:@"modifyPasswordIcon",@"messageIcon", @"orderIcon", @"invoiceIcon", nil],
    ...
    if (indexPath.section < self.cellTitleArray.count) {
        if (0 == indexPath.section) {
            switch (indexPath.row) {
                case 0: {
                    [self.navigationController pushViewController:[ModifyPasswordViewController new] animated:YES];
                    break;
