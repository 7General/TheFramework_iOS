...
#define DDFontMedium(obj) [UIFont fontWithName:@"STHeitiSC-Medium" size:obj]
#define DDMFONTMedium_BY_SCREEN(obj) ({DDMWIDTH >= 414 ? DDFontMedium(obj + 2) :  DDFontMedium(obj);})

#define DDFontLight(obj) [UIFont fontWithName:@"STHeitiSC-Light" size:obj]
#define DDMFONTLight_BY_SCREEN(obj) ({DDMWIDTH >= 414 ? DDFontLight(obj + 2) :  DDFontLight(obj);})
