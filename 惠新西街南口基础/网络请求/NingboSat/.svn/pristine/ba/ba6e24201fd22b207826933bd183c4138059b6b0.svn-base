...
@required
/**设置行数数量*/
-(NSInteger)CpickerView:(nullable UIPickerView *)pickerView numberOfRowsInPicker:(NSInteger)component;

@optional
/**设置每行的显示富文本字体*/
- (NSAttributedString *)CpickerView:(nullable UIPickerView *)pickerView attributedTitleForRowTtile:(NSInteger)row forComponent:(NSInteger)component;

/**设置每行返回的view*/
- (UIView *)CpickerView:(nullable UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view;
@end
