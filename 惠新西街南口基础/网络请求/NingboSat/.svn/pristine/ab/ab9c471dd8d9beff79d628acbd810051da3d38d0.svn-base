...
/*定义属性*/
// DateLabel默认文字颜色
#define MSS_TextColor  MSS_UTILS_COLORRGB(0, 0, 0) // [UIColor blackColor]
// DateLabel选中时的背景色
#define MSS_SelectBackgroundColor MSS_UTILS_COLORRGB(250, 91, 52)
// DateLabel选中后文字颜色
...
// 周末颜色
#define MSS_WeekEndTextColor  MSS_UTILS_COLORRGB(180, 180, 180)//[UIColor redColor]
// 不可点击文字颜色
#define MSS_TouchUnableTextColor MSS_UTILS_COLORRGB(150, 150, 150)
// 周视图高度
#define MSS_WeekViewHeight 40
// headerView线颜色
#define MSS_HeaderViewLineColor MSS_UTILS_COLORRGB(230, 230, 230)
// headerView文字颜色
#define MSS_HeaderViewTextColor MSS_UTILS_COLORRGB(80, 80, 80)
// headerView高度
